...
This blog uses **Mermaid diagrams** which render automatically on GitHub and many markdown viewers. 
...
4. **MySQL XA Lock Lifecycle** - Timeline and flow of lock states
5. **PostgreSQL Lock Lifecycle** - Prepared transaction lock behavior
